...
if(isset($_POST['simpan'])){
	...
	$update = mysqli_query($koneksi, "UPDATE siswa SET siswa_nis='$nis', siswa_nama='$nama', siswa_kelas='$kelas', siswa_jurusan='$jurusan', siswa_alamat='$alamat', siswa_jurusan='$no_telp' WHERE siswa_id='$id'") or die(mysqli_error($koneksi));
